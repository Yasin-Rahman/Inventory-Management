...
def clickedbtn2():
    ...
    lbl = Label(c_menu_window, text="Customer")
    lbl.grid(column=0, row=0)
...
def clickedbtn3():
    ...
    lbl = Label(s_menu_window, text="Supplier")
    lbl.grid(column=0, row=0)
...
def clickedbtn4():
    ...
    lbl = Label(r_menu_window, text="Supplier")
    lbl.grid(column=0, row=0)
...
def clickedbtn5():
    ...
    r_menu_window.geometry('350x200')
    r_menu_window.title("Pharmacy Management Software")
    lbl = Label(r_menu_window, text="Invoice")
    lbl.grid(column=0, row=0)
    lbl2 = Label(r_menu_window, text="What would you like to do!")
    lbl2.grid(column=0, row=1)
...
lbl2.grid(column=0, row=1)
btn1 = Button(window, text="Medicine",fg="red", command=clickedbtn1)
btn1.grid(column=0, row=2)
btn2 = Button(window, text="Customer",fg="red", command=clickedbtn2)
btn2.grid(column=0, row=3)
btn3 = Button(window, text="Supplier",fg="red", command=clickedbtn3)
btn3.grid(column=0, row=4)
btn4 = Button(window, text="Report",fg="red", command=clickedbtn4)
btn4.grid(column=0, row=5)
btn5 = Button(window, text="Invoicing",fg="red", command=clickedbtn5)
